...
// https://jqueryvalidation.org/jQuery.validator.format/
    ...
    $.extend( $.validator, {
        ...
        messages: {
            ...
            equalTo: "Ø±Ø¬Ø§Ø¡ Ø¥Ø¯Ø®Ø§Ù„ Ù†ÙØ³ Ø§Ù„Ù‚ÙŠÙ…Ø©*",
            extension: "Ø±Ø¬Ø§Ø¡ Ø¥Ø¯Ø®Ø§Ù„ Ù…Ù„Ù Ø¨Ø§Ù…ØªØ¯Ø§Ø¯ Ù…ÙˆØ§ÙÙ‚ Ø¹Ù„ÙŠÙ‡*",
            maxlength: $.validator.format("Ø§Ù„Ø­Ø¯ Ø§Ù„Ø£Ù‚ØµÙ‰ Ù„Ø¹Ø¯Ø¯ Ø§Ù„Ø£Ø±Ù‚Ø§Ù… Ù‡Ùˆ {0}*"),
            minlength: $.validator.format("Ø§Ù„Ø­Ø¯ Ø§Ù„Ø£Ø¯Ù†Ù‰ Ù„Ø¹Ø¯Ø¯ Ø§Ù„Ø£Ø±Ù‚Ø§Ù… Ù‡Ùˆ {0}*"),
